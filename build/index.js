...
function browser_get_width() { const { width, height } = canvas.getBoundingClientRect(); return width; }
function browser_get_height() { const { width, height } = canvas.getBoundingClientRect(); return height; }
...
// end include: preamble.js
  ...
  function _wgpuBindGroupLayoutRelease(id) { WebGPU.mgrBindGroupLayout.release(id) }

  function _wgpuBindGroupRelease(id) { WebGPU.mgrBindGroup.release(id) }
  ...
  function _wgpuBufferRelease(id) { WebGPU.mgrBuffer.release(id) }
  ...
  function _wgpuRenderPipelineRelease(id) { WebGPU.mgrRenderPipeline.release(id) }

  function _wgpuSamplerRelease(id) { WebGPU.mgrSampler.release(id) }

  function _wgpuShaderModuleRelease(id) { WebGPU.mgrShaderModule.release(id) }
  ...
  function _wgpuSwapChainRelease(id) { WebGPU.mgrSwapChain.release(id) }
  ...
  function _wgpuTextureRelease(id) { WebGPU.mgrTexture.release(id) }

  function _wgpuTextureViewRelease(id) { WebGPU.mgrTextureView.release(id) }
...
var wasmImports = {
  ...
  abort: _abort,
  browser_get_height: browser_get_height,
  browser_get_width: browser_get_width,
...
var ___start_em_js = Module['___start_em_js'] = 124292;
var ___stop_em_js = Module['___stop_em_js'] = 124457;
